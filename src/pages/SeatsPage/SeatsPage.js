...
export default function SeatsPage({ setPedido }) {
  ...
  useEffect(() => {
    const requisicao = axios.get(
      `https://mock-api.driven.com.br/api/v8/cineflex/showtimes/${idSessao["idSessao"]}/seats`
    );
  ...
  function selecionar(seat) {
    if (seat.isAvailable === false) {
      ...
      setSelecionados([
        ...selecionados.filter((elemento) => elemento.id !== seat.id),
      ]);
    }
  }
